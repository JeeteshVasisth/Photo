  ...
  return (
    <section id="contact" className="bg-portfolio-background py-20 px-4 sm:px-6 lg:px-8" data-testid="contact-section">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="portfolio-neutral-dark mb-12 max-w-2xl mx-auto" data-testid="text-contact-description">
        ...
        <div className="flex justify-center space-x-6">
          <a href="#" className="portfolio-neutral-dark hover:portfolio-accent transition-colors" data-testid="link-social-twitter">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
            </svg>
          </a>
          <a href="#" className="portfolio-neutral-dark hover:portfolio-accent transition-colors" data-testid="link-social-pinterest">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="#" className="portfolio-neutral-dark hover:portfolio-accent transition-colors" data-testid="link-social-instagram">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
